...
expression_matrix <- as.matrix(read.csv("./HPV16_results/16_QC2_expression_matrix.csv", row.names = 1))
# Leer los metadatos
metadata <- read.csv("./HPV16_results/16_QC2_metadata.csv", row.names = 1)
...
write.csv(cluster_annotations, "./HPV16_results/cluster_annotations16.csv", row.names = FALSE)
